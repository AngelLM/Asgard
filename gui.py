...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(410, 60, 451, 491))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 10, 351, 71))
        ...
        self.horizontalLayout_4.addWidget(self.SerialPortLabel)
        self.SerialPortComboBox = QtWidgets.QComboBox(self.layoutWidget1)
        ...
        self.horizontalLayout_4.addWidget(self.SerialPortComboBox)
        ...
        self.horizontalLayout_3.addWidget(self.BaudRateLabel)
        ...
        self.RobotStateLabel = QtWidgets.QLabel(self.layoutWidget1)
        self.RobotStateLabel.setMinimumSize(QtCore.QSize(45, 22))
        self.RobotStateLabel.setMaximumSize(QtCore.QSize(45, 22))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.RobotStateLabel.setFont(font)
        self.RobotStateLabel.setObjectName("RobotStateLabel")
        self.horizontalLayout_2.addWidget(self.RobotStateLabel)
        self.RobotStateDisplay = QtWidgets.QLabel(self.layoutWidget1)
        self.RobotStateDisplay.setMinimumSize(QtCore.QSize(99, 22))
        ...
        self.horizontalLayout_2.addWidget(self.RobotStateDisplay)
        ...
        self.label_54.setGeometry(QtCore.QRect(540, 20, 211, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit.setGeometry(QtCore.QRect(40, 810, 711, 20))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton_47 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_47.setGeometry(QtCore.QRect(760, 810, 91, 23))
        self.pushButton_47.setObjectName("pushButton_47")
        self.checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox.setGeometry(QtCore.QRect(720, 840, 131, 17))
        self.checkBox.setObjectName("checkBox")
        self.checkBox_2 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_2.setGeometry(QtCore.QRect(640, 840, 71, 17))
        self.checkBox_2.setChecked(True)
        self.checkBox_2.setObjectName("checkBox_2")
        self.label_61 = QtWidgets.QLabel(self.centralwidget)
        self.label_61.setGeometry(QtCore.QRect(400, 565, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(40, 600, 811, 201))
        ...
        self.GripperDec1Button = QtWidgets.QPushButton(self.GripperFrame)
        self.GripperDec1Button.setGeometry(QtCore.QRect(160, 50, 41, 23))
        self.GripperDec1Button.setObjectName("GripperDec1Button")
        self.GripperDec10Button = QtWidgets.QPushButton(self.GripperFrame)
        self.GripperDec10Button.setGeometry(QtCore.QRect(110, 50, 41, 23))
        self.GripperDec10Button.setObjectName("GripperDec10Button")
        ...
        self.GripperInc10Button = QtWidgets.QPushButton(self.GripperFrame)
        self.GripperInc10Button.setGeometry(QtCore.QRect(280, 50, 41, 23))
        self.GripperInc10Button.setObjectName("GripperInc10Button")
        self.GripperInc1Button = QtWidgets.QPushButton(self.GripperFrame)
        self.GripperInc1Button.setGeometry(QtCore.QRect(230, 50, 41, 23))
        self.GripperInc1Button.setObjectName("GripperInc1Button")
        self.GripperSlider = QtWidgets.QSlider(self.GripperFrame)
        self.GripperSlider.setGeometry(QtCore.QRect(110, 10, 211, 22))
        self.GripperSlider.setMinimum(0)
        self.GripperSlider.setMaximum(100)
        self.GripperSlider.setTracking(True)
        self.GripperSlider.setOrientation(QtCore.Qt.Horizontal)
        self.GripperSlider.setInvertedAppearance(False)
        self.GripperSlider.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.GripperSlider.setTickInterval(20)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(20, 300, 351, 168))
        ...
        self.IkIncButtonZ = QtWidgets.QPushButton(self.layoutWidget2)
        ...
        self.IkDecButtonZ = QtWidgets.QPushButton(self.layoutWidget2)
        ...
        self.IkIncButtonY = QtWidgets.QPushButton(self.layoutWidget2)
        ...
        self.IkDecButtonY = QtWidgets.QPushButton(self.layoutWidget2)
        ...
        self.IkIncButtonX = QtWidgets.QPushButton(self.layoutWidget2)
        ...
        self.IkDecButtonX = QtWidgets.QPushButton(self.layoutWidget2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_47.setText(_translate("MainWindow", "Send"))
        self.checkBox.setText(_translate("MainWindow", "Hide Some Responses"))
        self.checkBox_2.setText(_translate("MainWindow", "Autoscroll"))
        self.label_61.setText(_translate("MainWindow", "Console"))
        self.plainTextEdit.setPlainText(_translate("MainWindow", "G17 G20 G90 G94 G54\n"
"G0 Z0.25\n"
"X-0.5 Y0.2\n"
"Z0.1\n"
"G01 Z0. F5.\n"
...
"G00 X0. Y0. Z0.25"))
        ...
        self.GripperDec1Button.setText(_translate("MainWindow", "-1%"))
        self.GripperDec10Button.setText(_translate("MainWindow", "-10%"))
        ...
        self.GripperInc10Button.setText(_translate("MainWindow", "+10%"))
        self.GripperInc1Button.setText(_translate("MainWindow", "+1%"))
